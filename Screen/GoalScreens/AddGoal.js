...
const AddGoal = ({ route, navigation }) => {
    ...
    const renderThemes = () => {
        return themeDetails.map((theme) => {
            return <Picker.Item key={theme.theme_id} label={theme.theme_name} value={theme.theme_id} />
        })
    }
                    ...
                    await fetch(Endpoints.add_goal, {
                        ...
                        .then((responseJson) => {
                            ...
                            if (responseJson.status === 'success') {
                                ...
                                navigation.navigate("ListTasks", { goal_id: response_goal_id, isGoalAddFormInStack: true })
                                // console.log(
        ...
        <View style={{ flex: 1 }}>
            ...
            <ScrollView
                ...
                <KeyboardAvoidingView enabled>
                    ...
                    <GoalTextInput
                        onChangeText={(goalDescription) => setGoalDescription(goalDescription)}
                    ...
                    <View style={styles.SectionStyle}>
                        <DateInput
                            ...
                            inputPlaceholder="Goal Start Date"
                            date={goalStartDate}
                            onDateChange={(goalStartDate) => {
                    ...
                    <View style={styles.SectionStyle}>
                        <DateInput
                            ...
                            inputPlaceholder="Goal End Date"
                            date={goalEndDate}
                            onDateChange={(goalEndDate) => {
